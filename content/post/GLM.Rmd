...
print(smod1.glm)
```
Ahora, consideremos un modelo con una función de conexión logaritmica y una varianza con distribución gaussiana. Esto es equivalente a un modelo de regresión no lineal con media exponencial, o, lo que es lo mismo, un modelo log-lin.
