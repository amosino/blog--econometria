...
```{r}
scores <- read.csv("https://raw.githubusercontent.com/amosino/course--econometria_salud/master/econometria_salud--datos/HsbData.csv")
scores
```
