...
Como primer paso, hacemos un resumem estadístico de la variable `totalscore` para cada una de las submuestras. Estas submuestras pueden calcularse como sigue:
